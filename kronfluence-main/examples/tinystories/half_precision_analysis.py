...
def main():
    ...
    full_scores = Analyzer.load_file("influence_results/tinystories/scores_ekfac/pairwise_scores.safetensors")[
        "all_modules"
    ]
    half_scores = Analyzer.load_file("influence_results/tinystories/scores_ekfac_half/pairwise_scores.safetensors")[
        "all_modules"
    ].float()
